...
UPSCALE_API_URL = "https://api.stability.ai/v2/stable-image/upscale/conservative" # Corrected URL
...
def generate_analysis():
    if not GOOGLE_API_KEY: return jsonify({'error': 'Google AI API key not found'}), 500
    json_data = request.get_json()
